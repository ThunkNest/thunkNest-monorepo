...
public class PostController {
    ...
    @Operation(
        ...
        description = "Fetches a post by its unique identifier.")
    @GetMapping("/{id}")
    ...
    @Operation(
        ...
        description = "Updates the details of an existing post by its ID.")
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    ...
    @Operation(
        ...
        description = "Marks a post as deleted by its unique identifier.")
    @DeleteMapping("/{id}")
    ...
    @Operation(
        ...
        description = "Adds a new reply to the specified post.")
    ...
    @Operation(
        summary = "Tag a post",
        description = "Adds a tag to the specified post by its ID.")
